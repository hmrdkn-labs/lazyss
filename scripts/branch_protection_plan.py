...
def branch_protection_payload(required_checks):
    return {
...
def markdown_plan(repo, branch, required_checks, json_output):
...
def main(argv=None):
    ...
    payload = branch_protection_payload(required_checks)
    json_text = json.dumps(payload, indent=2, sort_keys=True) + "\n"
    markdown_text = markdown_plan(args.repo, args.branch, required_checks, args.json_output)
